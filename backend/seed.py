...
def seed_permissions(db) -> dict[str, Permission]:
    """Insert all permissions and role assignments. Idempotent."""
    print("  Seeding permissions…")

    # Insert permissions (skip if already present by name)
    ...
    # Insert role→permission assignments (skip duplicates)
